...
The links on the sidebar will bring you to the release folder on github, which will also allow you to find the **Issues page** and the **readme files**, listing all available features and limitations in detail per core.
