...
Until [MiSTer Discrete](https://github.com/jopdorp/MiSTer-Discrete) is more mature, there is no convenient way to directly simulate electronic circuits in real time on the MiSTer.
So to implement these type of circuits in fpga, you will have to come up with some kind of simulation of the behavior of the electronic circuits.
