...
- [What power supply is compatible with MiSTer?](#what-power-supply-is-compatible-with-mister)
...
- [When is an N64 core coming?](#when-is-an-n64-core-coming)
...
SNAC (Serial Native Accessory Converter) is used for direct wiring. Supporting cores (SNES, Genesis, NES, and TG16) allow you to directly connect original controllers. See [this page](https://github.com/blue212/SNAC) for details on SNAC.
